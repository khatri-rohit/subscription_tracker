                                    ...
                                    >
                                        <NavLink
                                            ...
                                            className={(location.pathname.split('/')[3] === item.path || location.pathname.split('/').length === 2) ?
                                                `flex items-center text-base sm:text-lg text-black dark:text-white bg-${item.color}-600 transition-all py-2 px-4 rounded-md hover:bg-${item.color}-700 dark:bg-${item.color}-500 dark:hover:bg-${item.color}-600` :
